...
function lib:Window(text, preset, closebind)
    ...
    PresetColor = preset or Color3.fromRGB(55, 120, 224)
    fs = false
    ...
    spawn(function()
        ...
        OPENCLOSE.Name = "HoHo"
        OPENCLOSE.Parent = ui
        OPENCLOSE.BackgroundColor3 = PresetColor
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            Tab.CanvasSize = UDim2.new(0, 0, 0, TabLayout.AbsoluteContentSize.Y)
			DropTTT:Clear = function()
				for e,g in pairs(DropItemHolder:GetChildren()) do
					if g.Name == "Item" then
						g:Destroy()
					end
				end
			...
			DropTTT:Add = function(new_text)
				table.insert(list, new_text)
				for i, v in next, list do
					itemcount = itemcount + 1
					if itemcount <= 3 then
						framesize = framesize + 26
        ...
        function tabcontent:Label(text)
			...
			lbrt:Refresh = function(newt)
				LabelTitle.Text = newt
			end
			return lbrt
        end
